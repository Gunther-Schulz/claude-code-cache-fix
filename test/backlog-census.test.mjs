...
test("censusText: the fixture's exact rows and summary", () => {
  const expected = [
    ...
    "",
    "# grades: READY=3 RECORD=0 OPEN=1 HOT=1 OPEN/HOT=1 PARKED=1 DONE=1 RESOLVED=1 FIXED=0 BUILT=0 PARTLY=0 CORRECTED=0 DOWNGRADED=0 CLOSED=0 DROPPED=0 SHIPPED=0 ANSWERED=0 RETIRED=0 HANDOFF=0 BUST=0 FINDING=0 NEW=0 CANDIDATE=0 INCIDENT=0 DATAPOINT=0 CORROBORATION=0 QUEUED=0 UNDISPOSITIONED=0 COMMITTED=0 DECISION=0 DECISIONS=0 REFRAMED=0 HALF=0 TOOL=0 MECHANISM=0 IN=0 ECONNRESET=0 UNCLASSIFIED=1",
    "# UNCLASSIFIED bullets: 27",
