...
|---|---|---|---|
| 1 | Mid-history insertion (queue splice, notification, tool-result race, task_reminder) | entry inserted at index < tail | MITIGATED-half (ladder — RETIRED 2026-07-28, implementation REMOVED, NOT coverage: `proxy-mid-history-breakpoint-ladder.md`) → NEAR-ZERO (insertion-normalization, this branch) |
