...
|---|---|---|---|
| 1 | Mid-history insertion (queue splice, notification, tool-result race, task_reminder) | entry inserted at index < tail | ~~MITIGATED-half (ladder)~~ **LADDER RETIRED 2026-07-28, implementation REMOVED — it is not coverage; see `proxy-mid-history-breakpoint-ladder.md`** → NEAR-ZERO (insertion-normalization, this branch) |
